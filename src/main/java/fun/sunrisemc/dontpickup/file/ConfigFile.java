...
public class ConfigFile {
    ...
    public static YamlConfiguration get(@NotNull String name, boolean copyMissingDefaults) {
        ...
        if (copyMissingDefaults) {
            ...
            try {
                ...
                DontPickUpPlugin.logSevere("Failed to get default configuration for " + name + ".yml.");
                return config;
            }
    ...
    public static boolean save(@NotNull String name, @NotNull YamlConfiguration config) {
        ...
        try {
            ...
            DontPickUpPlugin.logSevere("Failed to save configuration file for " + name + ".yml.");
            return false;
        }
    }
    ...
    public static boolean delete(@NotNull String name) {
        ...
        try {
            ...
            DontPickUpPlugin.logSevere("Failed to delete configuration file for " + name + ".yml.");
            return false;
        }
    }
