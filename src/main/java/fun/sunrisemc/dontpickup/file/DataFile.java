...
public class DataFile {
    ...
    public static YamlConfiguration get(@NotNull String name) {
        ...
        if (!dataFile.exists()) {
            try {
                ...
                DontPickUpPlugin.logSevere("Failed to create data file for " + name + ".yml.");
    ...
    public static boolean save(@NotNull String name, @NotNull YamlConfiguration data) {
        ...
        try {
            ...
            DontPickUpPlugin.logSevere("Failed to save data file for " + name + ".yml.");
            return false;
        }
    }
    ...
    public static boolean delete(@NotNull String name) {
        ...
        try {
            ...
            DontPickUpPlugin.logSevere("Failed to delete data file for " + name + ".yml.");
            return false;
        }
    }
